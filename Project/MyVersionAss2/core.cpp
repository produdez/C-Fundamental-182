...
//     NOTE: Any data that you allocated MUST BE CLEAN UP
     cout<<"All data terminated! ... Exiting...."<<endl;
}
...
void LoadData(const char* pFName, void* &pData) {
    ...
    cout<<record_list->N<<" empty records have been created for storing data"<<endl;
    ...
    cout<<"Order of record column attributes have been loaded!"<<endl;
...
*/
    ...
    input.close();
    cout<<"...Finish loading data into records!!"<<endl;
...
void ReleaseData(void* &pData) { // Release records data only
    ...
    cout<<"Releasing records data..."<<endl;
